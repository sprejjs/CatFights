...
<body>
    ...
    <div class="competitor" onclick="window.location.href = '/servlets/game?round_winner=a'">
        <h4><%= catA.getName() %></h4>
        <img src="<%= catA.getPhotoPath() %>">
    </div>
    <div class="competitor" onclick="window.location.href = '/servlets/game?round_winner=b'">
        <h4><%= catB.getName() %></h4>
